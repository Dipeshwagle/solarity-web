...
const Review = () => {
  ...
  return (
    <div className="flex flex-col gap-6 p-10 border border-brandblack rounded-3xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <span className=" text-brand-md text-gray-950">Squad Name</span>
      ...
      <div className="flex flex-col max-w-sm ">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between ">
            <span className=" text-brand-md text-gray-950">Squad Type</span>
            <span className=" text-brand-lg">Teams</span>
          </div>
        </div>
      </div>
