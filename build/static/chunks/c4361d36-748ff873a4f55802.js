"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[4870],{

/***/ 3029:
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "qT": function() { return /* binding */ MintLayout; },
/* harmony export */   "H_": function() { return /* binding */ TOKEN_PROGRAM_ID; },
/* harmony export */   "WU": function() { return /* binding */ Token; }
/* harmony export */ });
/* unused harmony exports ASSOCIATED_TOKEN_PROGRAM_ID, AccountLayout, NATIVE_MINT, u64 */
...
function sendAndConfirmTransaction(title, connection, transaction, ...signers) {
  return (0,_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.sendAndConfirmTransaction)(connection, transaction, signers, {
    skipPreflight: false
  });
}
...
const ASSOCIATED_TOKEN_PROGRAM_ID = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey('ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL');
...
const NATIVE_MINT = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey('So11111111111111111111111111111111111111112');
/**
...
class Token {
  ...
  constructor(connection, publicKey, programId, payer) {
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(this, "connection", void 0);

    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(this, "publicKey", void 0);

    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(this, "programId", void 0);

    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(this, "associatedProgramId", void 0);

    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(this, "payer", void 0);
  ...
  static async createMint(connection, payer, mintAuthority, freezeAuthority, decimals, programId) {
    const mintAccount = _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Keypair.generate();
    ...
    transaction.add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.SystemProgram.createAccount({
  ...
  async createAccount(owner) {
    ...
    const newAccount = _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Keypair.generate();
    const transaction = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction();
    transaction.add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.SystemProgram.createAccount({
  ...
  async createAssociatedTokenAccountInternal(owner, associatedAddress) {
    await sendAndConfirmTransaction('CreateAssociatedTokenAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createAssociatedTokenAccountInstruction(this.associatedProgramId, this.programId, this.publicKey, associatedAddress, owner, this.payer.publicKey)), this.payer);
  ...
  static async createWrappedNativeAccount(connection, programId, owner, payer, amount) {
    ...
    transaction.add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.SystemProgram.transfer({
      fromPubkey: payer.publicKey,
  ...
  async createMultisig(m, signers) {
    const multisigAccount = _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Keypair.generate(); // Allocate memory for the account
  ...
  async getMintInfo() {
    ...
    if (mintInfo.mintAuthorityOption === 0) {
      ...
      mintInfo.mintAuthority = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(mintInfo.mintAuthority);
    }
    ...
    if (mintInfo.freezeAuthorityOption === 0) {
      ...
      mintInfo.freezeAuthority = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(mintInfo.freezeAuthority);
    }
  ...
  async getAccountInfo(account, commitment) {
    ...
    accountInfo.mint = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(accountInfo.mint);
    accountInfo.owner = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(accountInfo.owner);
    ...
    if (accountInfo.delegateOption === 0) {
      ...
      accountInfo.delegate = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(accountInfo.delegate);
    ...
    if (accountInfo.closeAuthorityOption === 0) {
      ...
      accountInfo.closeAuthority = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(accountInfo.closeAuthority);
    }
  ...
  async getMultisigInfo(multisig) {
    ...
    multisigInfo.signer1 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer1);
    multisigInfo.signer2 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer2);
    multisigInfo.signer3 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer3);
    multisigInfo.signer4 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer4);
    multisigInfo.signer5 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer5);
    multisigInfo.signer6 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer6);
    multisigInfo.signer7 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer7);
    multisigInfo.signer8 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer8);
    multisigInfo.signer9 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer9);
    multisigInfo.signer10 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer10);
    multisigInfo.signer11 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(multisigInfo.signer11);
    return multisigInfo;
  }
  /**
  ...
  async transfer(source, destination, owner, multiSigners, amount) {
    ...
    return await sendAndConfirmTransaction('Transfer', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createTransferInstruction(this.programId, source, destination, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
  ...
  async approve(account, delegate, owner, multiSigners, amount) {
    ...
    await sendAndConfirmTransaction('Approve', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createApproveInstruction(this.programId, account, delegate, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
  ...
  async revoke(account, owner, multiSigners) {
    ...
    await sendAndConfirmTransaction('Revoke', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createRevokeInstruction(this.programId, account, ownerPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
  ...
  async setAuthority(account, newAuthority, authorityType, currentAuthority, multiSigners) {
    ...
    await sendAndConfirmTransaction('SetAuthority', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createSetAuthorityInstruction(this.programId, account, newAuthority, authorityType, currentAuthorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
   * Mint new tokens
   *
  ...
  async mintTo(dest, authority, multiSigners, amount) {
    ...
    await sendAndConfirmTransaction('MintTo', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createMintToInstruction(this.programId, this.publicKey, dest, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
   * Burn tokens
   *
  ...
  async burn(account, owner, multiSigners, amount) {
    ...
    await sendAndConfirmTransaction('Burn', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createBurnInstruction(this.programId, this.publicKey, account, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
   * Close account
   *
  ...
  async closeAccount(account, dest, authority, multiSigners) {
    ...
    await sendAndConfirmTransaction('CloseAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createCloseAccountInstruction(this.programId, account, dest, authorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
   * Freeze account
   *
  ...
  async freezeAccount(account, authority, multiSigners) {
    ...
    await sendAndConfirmTransaction('FreezeAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createFreezeAccountInstruction(this.programId, account, this.publicKey, authorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
   * Thaw account
   *
  ...
  async thawAccount(account, authority, multiSigners) {
    ...
    await sendAndConfirmTransaction('ThawAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createThawAccountInstruction(this.programId, account, this.publicKey, authorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
  ...
  async transferChecked(source, destination, owner, multiSigners, amount, decimals) {
    ...
    return await sendAndConfirmTransaction('TransferChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createTransferCheckedInstruction(this.programId, source, this.publicKey, destination, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
   * Grant a third-party permission to transfer up the specified number of tokens from an account,
  ...
  async approveChecked(account, delegate, owner, multiSigners, amount, decimals) {
    ...
    await sendAndConfirmTransaction('ApproveChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createApproveCheckedInstruction(this.programId, account, this.publicKey, delegate, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
  ...
  async mintToChecked(dest, authority, multiSigners, amount, decimals) {
    ...
    await sendAndConfirmTransaction('MintToChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createMintToCheckedInstruction(this.programId, this.publicKey, dest, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
  ...
  async burnChecked(account, owner, multiSigners, amount, decimals) {
    ...
    await sendAndConfirmTransaction('BurnChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createBurnCheckedInstruction(this.programId, this.publicKey, account, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
  ...
  async syncNative(nativeAccount) {
    await sendAndConfirmTransaction('SyncNative', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.Transaction().add(Token.createSyncNativeInstruction(this.programId, nativeAccount)), this.payer);
  }
  /**
  ...
  static createInitMintInstruction(programId, mint, decimals, mintAuthority, freezeAuthority) {
    ...
    let data = buffer.Buffer.alloc(1024);
    {
      const encodeLength = commandDataLayout.encode({
        ...
        freezeAuthority: pubkeyToBuffer(freezeAuthority || new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(0))
      }, data);
  ...
  static createSetAuthorityInstruction(programId, account, newAuthority, authorityType, currentAuthority, multiSigners) {
    ...
    let data = buffer.Buffer.alloc(1024);
    {
      const encodeLength = commandDataLayout.encode({
        ...
        newAuthority: pubkeyToBuffer(newAuthority || new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey(0))
      }, data);
      data = data.slice(0, encodeLength);
    }
    let keys = [{
  ...
  static async getAssociatedTokenAddress(associatedProgramId, programId, mint, owner, allowOwnerOffCurve = false) {
    if (!allowOwnerOffCurve && !_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey.isOnCurve(owner.toBuffer())) {
      throw new Error(`Owner cannot sign: ${owner.toString()}`);
    }

    return (await _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__.PublicKey.findProgramAddress([owner.toBuffer(), programId.toBuffer(), mint.toBuffer()], associatedProgramId))[0];
  }
  /**
